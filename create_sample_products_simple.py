#!/usr/bin/env python
"""
Simple script to create 10 sample products directly in the database
"""
import os
import sys
import django
...
# Disable image search to avoid CLIP model download
os.environ['SKIP_IMAGE_SEARCH_INIT'] = '1'
...
def create_products():
    ...
    print(f"Using Category: {category.name} (ID: {category.categoryId})")
    ...
    source, _ = Source.objects.get_or_create(name='ProTools Supply Co.')
    ...
    for product_data in products_data:
        ...
        print(f"✅ Created: {product.productName} (ID: {product.productId})")
        created_count += 1
    ...
    if created_count > 0:
        ...
        print("You can now test them in your Flutter app or Django admin.")
    else:
